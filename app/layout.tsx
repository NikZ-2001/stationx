...
export const metadata: Metadata = {
  ...
  description: "StationX offers document printing, photo printing, sticker printing, lamination, spiral binding and soft binding in Ambattur, Chennai with home delivery.",
  keywords: [
  ...
  "lamination Ambattur",
  "spiral binding Ambattur",
  "soft binding Ambattur",
  "document printing Chennai",
  "photo printing Chennai",
  "binding service Ambattur",
  "lamination service Chennai",
  "print shop Ambattur",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "name": "StationX",
              "description": "Premium printing, lamination, spiral binding and soft binding service in Ambattur, Chennai. Offering document printing, photo printing, sticker printing with home delivery.",
              "url": "https://stationx.vercel.app",
