...
export const metadata: Metadata = {
  ...
  description: "Affordable printing prices in Ambattur, Chennai. B&W printout from ₹2, color printing from ₹10, photo printing from ₹60. No hidden charges.",
  openGraph: {
    title: "Pricing — StationX Ambattur Chennai",
    description: "B&W printout from ₹2, color printing from ₹10, photo prints from ₹60. Affordable and transparent pricing in Ambattur Chennai.",
    ...
    <main className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
      <div className="max-w-5xl mx-auto px-4 py-20">
        ...
        <div className="space-y-8 mb-10">
          {categories.map((cat) => (
            <div key={cat.title} className="bg-white rounded-2xl shadow-sm p-8">
              <h2 className="text-xl font-bold text-gray-900 font-[var(--font-playfair)] mb-6 flex items-center gap-2 border-b border-gray-100 pb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {cat.items.map((item) => (
                  <div key={item.label} className="border border-gray-100 rounded-2xl p-5 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    ...
                    <p className="text-sm font-semibold text-gray-900 mb-4 leading-tight">{item.label}</p>
                    ...
                    <div className="flex items-center justify-between bg-orange-50 rounded-xl px-3 py-2 mb-4">
                      <span className="text-xs text-orange-600 font-medium">Bulk Rate</span>
                      <div className="text-right">
                    ...
                    <a href={item.waLink} target="_blank" rel="noreferrer" className="inline-block w-full text-center bg-orange-500 text-white py-2.5 rounded-full text-sm font-semibold hover:bg-orange-600 transition shadow-md shadow-orange-100">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
          <h2 className="text-lg font-bold text-gray-900 font-[var(--font-playfair)] mb-4">📦 Included Services</h2>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            Bulk order or special requirement? We will give you the best price instantly on WhatsApp.
          </p>
          ...
          <p className="text-gray-400 text-xs mt-6">
            * Bulk pricing available for larger orders. Prices may vary for urgent orders.
          </p>
        </div>
