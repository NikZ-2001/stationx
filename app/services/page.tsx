...
const services = [
  {
    ...
    features: ["70 GSM Standard paper", "80 GSM Crisp paper", "A4 and A3 sizes", "Single & double side", "Bulk discounts available"],
    badge: "Most Popular",
  ...
  },
  {
    ...
    features: ["180 GSM Glossy paper", "Passport Size – 6 pcs", "Passport Size – 8 pcs", "Postcard 4x6 inch", "A4 & A3 photo prints"],
    badge: "Premium",
  ...
  },
  {
    ...
    description: "Premium glossy sticker printing on 130 GSM paper. Available in B&W and Color, A4 and A3 sizes.",
    features: ["130 GSM Glossy sticker paper", "A4 and A3 sizes", "B&W and Color options", "Neat rectangle/square cutting", "Bulk discounts available"],
    badge: "New",
