      ...
      <div className="max-w-6xl mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <span className="inline-block bg-orange-100 text-orange-600 text-xs font-semibold px-4 py-1 rounded-full mb-3 uppercase tracking-widest animate-fade-up">
            Premium Print & Finishing Services
          </span>
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6 font-[var(--font-playfair)] animate-fade-up delay-100">
            Print, Bind & <span className="text-orange-500">Deliver.</span>
          </h1>

          <p className="text-gray-600 text-lg mb-8 leading-relaxed animate-fade-up delay-200">
            Secure, premium quality printing, lamination, and binding services delivered fast, affordable, and right to your door.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mb-8 animate-fade-up delay-300">
            ...
            <span className="bg-white border border-orange-200 text-gray-600 text-sm px-4 py-2 rounded-full shadow-sm">🗂️ Lamination</span>
            <span className="bg-white border border-orange-200 text-gray-600 text-sm px-4 py-2 rounded-full shadow-sm">🔗 Spiral Binding</span>
            <span className="bg-white border border-orange-200 text-gray-600 text-sm px-4 py-2 rounded-full shadow-sm">📚 Soft Binding</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-up delay-400">
            ...
            <a href="/services" className="border-2 border-orange-500 text-orange-500 px-8 py-4 rounded-full font-semibold text-center hover:bg-orange-50 transition flex items-center justify-center gap-2">
              <i className="bi bi-grid" /> View Services
            </a>
          </div>
        ...
        <div className="hidden md:flex justify-center items-center animate-slide-in-right delay-200">
          <div className="relative w-80 h-80 cursor-pointer" onMouseEnter={handleHover} style={{ transition: "transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)", transform: spin ? "rotate(180deg) scale(1.05)" : "rotate(0deg) scale(1)" }}>
